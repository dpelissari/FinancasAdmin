            ...
            h.element = h.input = d, h.isOpen = !1,
                ...
                function () {
                    if (h.config.wrap && ["open", "close", "toggle", "clear"].forEach(function (t) {
                        ...
                        h.mobileInput = me("input", h.input.className + " flatpickr-mobile"), h.mobileInput.step = h.input.getAttribute("step") || "any", h.mobileInput.tabIndex = 1, h.mobileInput.type = e, h.mobileInput.disabled = h.input.disabled, h.mobileInput.required = h.input.required, h.mobileInput.placeholder = h.input.placeholder, h.mobileFormatStr = "datetime-local" === e ? "d/m/Y\\TH:i:S" : "date" === e ? "d/m/Y" : "H:i:S", 0 < h.selectedDates.length && (h.mobileInput.defaultValue = h.mobileInput.value = h.formatDate(h.selectedDates[0], h.mobileFormatStr)), h.config.minDate && (h.mobileInput.min = h.formatDate(h.config.minDate, "d/m/Y")), h.config.maxDate && (h.mobileInput.max = h.formatDate(h.config.maxDate, "d/m/Y")), h.input.type = "hidden", void 0 !== h.altInput && (h.altInput.type = "hidden");
                        try {
