            ...
            options: {
                tooltips: {
                    callbacks: {
                        ...
                        label: function (a, e) {
                            var t = "";
                            return t += ' R$<span class="popover-body-value">' + e.datasets[0].data[a.index] + "</span>"
                        }
                    }
                }
            },
            data: {
                labels: ["Renda total", "Gastos mensais", "Saldo Livre"],
                datasets: [{
                    data: [rendaTotal, gastoTotalMensal, rendaDisponivel],
